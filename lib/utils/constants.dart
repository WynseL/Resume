...
const Skills_4 = ["Others", "Machine Learning, Image Recognition, Internet of Things (IoT), Firebase, OpenCV, OpenID Authentication"];
...
const mClinicaGoes1stFlutterPHEvent = ["mClinica goes to Flutter Philippines’ 1st ever study jam", "September 25, 2019", "A Medium article I wrote for Flutter Philippines's 1st study jam for its upcoming hackathon event. Read all the details here."];
